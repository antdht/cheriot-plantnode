...
static constexpr uint8_t RaApproved =
  0x03; // payload: combined[32] (verdict OK)
// Device -> verifier:
static constexpr uint8_t RaNonceReply =
  0x01;                                  // payload: nonce_V[32] ‖ nonce_D[32]
 ...
 */
static constexpr size_t RaPlaintextMaxLength =
  1 + AttestationQuoteWireMaxLength;
