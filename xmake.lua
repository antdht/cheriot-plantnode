...
add_includedirs("src", "../sonata-software/network-stack/include",
                "../sonata-software/network-stack/examples/04.MQTT")
add_deps("freestanding", "debug", "DNS", "TCPIP", "NetAPI", "TLS",
         "Firewall", "SNTP", "MQTT", "time_helpers", "stdio")
...
after_link(function(target)
	...
	os.execv("uf2conv", { fw .. ".strip", "-b0x00000000", "-f0x6CE29E60", "-co", path.join(outdir, "plantnode.slot1.uf2") })
	os.execv("uf2conv", { fw .. ".strip", "-b0x10000000", "-f0x6CE29E60", "-co", path.join(outdir, "plantnode.slot2.uf2") })
	os.execv("uf2conv", { fw .. ".strip", "-b0x20000000", "-f0x6CE29E60", "-co", path.join(outdir, "plantnode.slot3.uf2") })
end)
